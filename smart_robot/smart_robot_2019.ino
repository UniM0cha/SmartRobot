...
{ //라인 트레이싱, 아날로그 센서
    while (1)
    {
        ...
        if (prizm.readLineSensor(3) == HIGH && prizm.readLineSensor(4) == HIGH)
            break;
    }
    wheel(0, 0, 0);
}
